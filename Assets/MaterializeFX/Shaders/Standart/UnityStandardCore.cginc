...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
    ...
    //MFX
    c.rgb += GetMfxEmission(i.mfxUv, posWorld, Emission(i.tex.xy), s.alpha);
...
VertexOutputForwardAdd vertForwardAdd (VertexInput v)
{
    ...
    //MFX
    PassMfxVertex2Fragment(v.uv0.xy, o.mfxUv);
    v.vertex.xyz += GetMfxVertexOffset(o.mfxUv, posWorld, v.normal);
...
)
{
    ...
    half3 emissiveColor = UNITY_BRDF_PBS (s.diffColor, s.specColor, s.oneMinusReflectivity, s.smoothness, s.normalWorld, -s.eyeVec, gi.light, gi.indirect).rgb;
        ...
        //MFX
        emissiveColor += GetMfxEmission(i.mfxUv, posWorld, Emission(i.tex.xy), s.alpha);
    #endif
