...
Shader "QFX/MFX/Uber/Standard Specular"
{
    Properties
    {
        ...
        _GlossMapScale("Smo  othness Factor", Range(0.0, 1.0)) = 1.0
		...
		_FringeAmount("Fringe Amount", Float) = 0.5
    	_FringeRampMap("Fringe Map", 2D) = "white"{}
