...
namespace Assets.MaterializeFX.Scripts
{
    internal sealed class MfxObjectMaterialUpdater
    {
        ...
        public MfxObjectMaterialUpdater(GameObject targetObject, bool modifyChildren, bool replaceMaterials, Material mfxTemplateMaterial, MfxShaderType mfxShaderType)
        {
        ...
        public void Replace(Material mfxMaterialTemplate)
        {
            ...
            foreach (var renderer in _renderers)
            {
                ...
                var newMaterials = MfxMaterialUtil.ReplaceMaterialsToMfx(mfxMaterialTemplate, rendererSharedMaterials, _mfxShaderType, false);
